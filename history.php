                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                    ...
                    <table>
                      ...
                      <?php
            include 'connect.php';
            $result=mysqli_query($con,"SELECT * FROM `tbl_payments` WHERE user_id='".$idd."' ");
            $count=1;
...
<!-- <?php
            include 'connect.php';
            $result2=mysqli_query($con,"SELECT * FROM `bunksign` WHERE id='".$idbunk."' ");
