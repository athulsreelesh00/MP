...
if($_SESSION["id"]==session_id())
{
  ...
  $bunkid = $_SESSION['pid2'] = $_GET['pid2'];
  include 'connect.php';
  $res = "SELECT * FROM bunksign WHERE id = $bunkid";
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <div class="price-btn blue">
                                    <a class="blue" href="search.php">Back</a>
                                </div>
          </li>
...
<!-- Price php -->
                ...
                if($row['petrol']==1)
                {
                  ...
                  echo "<form action='order2.php' method='post'><button class='btn btn-success' value='".$row['id']."' name='p1'>Buy ".$row['p1']."₹</button></form>"; 
                }
                else
                {
                  echo "<form action='#' method='post'><button class='btn btn-danger'  name='del1'>Out of Stock</button></form>"; 
                }
...
if($row['diesel']==1)
{
  ...
  echo "<form action='order2.php' method='post'><button class='btn btn-success' value='".$row['id']."' name='p2'>Buy ".$row['p2']."₹</button></form>"; 
}
else
{
  echo "<form action='#' method='post'><button class='btn btn-danger'  name='del1'>Out of Stock</button></form>"; 
              ...
              if($row['speed']==1)
                {
                  ...
                  echo "<form action='order2.php' method='post'><button class='btn btn-success' value='".$row['id']."' name='p3'>Buy ".$row['p3']."₹</button></form>"; 
                }
                else
                {
                  echo "<form action='#' method='post'><button class='btn btn-danger'  name='del1'>Out of Stock</button></form>"; 
...
if($row['power']==1)
{
  ...
  echo "<form action='order2.php' method='post'><button class='btn btn-success' value='".$row['id']."' name='p4'>Buy ".$row['p4']."₹</button></form>"; 
}
else
{
  echo "<form action='#' method='post'><button class='btn btn-danger'  name='del1'>Out of Stock</button></form>"; 
