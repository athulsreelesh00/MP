...
if($_SESSION["id"]==session_id())
{
  ...
  include 'connect.php';
  $res = "SELECT * FROM price WHERE id = $pid";
...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['fuel'];?>" readonly name="fuel">
    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Rate:</label>
    <input type="text" class="form-control" value="₹ <?php echo $row['amt'];?>" readonly name="price">
  </div>
  ...
  <div class="form-group">
    ...
    <select name="select" class="form-control">
      <option>in Litre</option>
      <option value="qty">01</option>
      <option value="qty">05</option>
      <option value="qty">10</option>
      <option value="qty">15</option>
    </select>
  </div>
