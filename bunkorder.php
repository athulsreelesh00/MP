...
.text-center
{
  ...
  top: 150px;
                    ...
                    <table>
                      ...
                      <?php
            include 'connect.php';
            $result=mysqli_query($con,"SELECT * FROM `tbl_payments` WHERE bunk_id='".$idd."'  ");
            $count=1;
            ...
            {?>
                        ...
                        <?php 
                          $user_id=$row["user_id"];
                          $result2=mysqli_query($con,"SELECT * FROM `usign` WHERE id='".$user_id."' ");
                      ...
                      <tr>
                        ...
                        <td><?php echo(round($distance,4) );?> </td>
