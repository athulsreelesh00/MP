...
$total=$_SESSION['total']=$qty * $amt;

?>
<form method="POST" action="pay.php">
    <br><br><?php  echo $qty;?> Litre 
    <?php echo $fuel; ?> <br>
    Rate: <?php  echo $amt; ?> ₹ <br>
    Payable: <?php echo $total; ?> ₹ <br><br>

    <input type ="submit" name="submit" class="btn btn-primary" value="Pay :<?php echo $total; ?> ₹ ">
</form>
...
<?php
    ...
    include 'connect.php';
    $add="INSERT INTO `uhistory`(`user_id`, `fuel`, `quantity`, `amount`, `latitude`, `longitude`, `payable`) VALUES ('$idd','$fuel','$qty','$amt','$latitude','$longitude','$total')";
