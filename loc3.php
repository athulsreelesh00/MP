...
<body>
  <div class="container-scroller"> 
    ...
    <form action="loc4.php" method="post">

<button type="button" name="btn" class="btn btn-primary" onClick="getLocation()">Share Live Location</button>
