...
<?php
    ...
    echo"<form action='payment.php' method='post'>";
        ...
        echo "<h3>".$name." Petroleum ".$district." , ".$state."</h3>";
        ...
        echo "<br>";
        echo "Quantity: ";
        echo $qty=$_SESSION['qty']=$_POST['select'];
        echo " litre's";
        echo "<br>";
        echo "Distance: ";
        echo $kmt;
        ...
        $total=$price + $deli;
        echo $total; echo " ₹";
        $tot=$_SESSION['total']=$total;
        echo "<br>";
        echo "___________________________________________";
        echo "<br>";
        echo "<i>NB: 10₹ Delivery Charge Per KM</i>";
        echo "<br>";
        echo "<br>";

    echo "<input type='submit' class='btn btn-primary' name='submit' value='Submit'></form>";
    }
?>  
<!-- Price php -->
