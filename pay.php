...
if($_SESSION["id"]==session_id())
{
  ...
  $id=$_SESSION['pid'];
  include 'connect.php';
  $res = "SELECT * FROM price WHERE id = '$id'";
    ...
    <div class="row">
        <div class="col-lg-4 mb-lg-0 mb-3">
            <div class="card p-3">
                ...
                <div class="d-flex align-items-center justify-content-between"> <small><span class="fw-bold">Expiry date:</span><span></span></small> <small><span class="fw-bold">Name:</span><span></span></small> </div>
            </div>
        </div>
        <div class="col-lg-4 mb-lg-0 mb-3">
            <div class="card p-3">
                    ...
                    <div class="collapse p-3 pt-0" id="collapseExample">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <p class="mb-0"><span class="fw-bold">Fuel Type:</span><span class="c-green">: <?php echo $row['fuel'];?></span></p>
                                <p class="mb-0"><span class="fw-bold">Rate:</span><span class="c-green">:₹ <?php echo $row['amt'];?></span></p>
                                <p class="mb-0"><span class="fw-bold">Quantity:</span><span class="c-green">:<?php echo $qty;?> litres</span></p>
                                <p class="mb-0"><span class="fw-bold">Payable:</span><span class="c-green">:₹ <?php echo $total;?></span></p>
