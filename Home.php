      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <div class="price-btn blue">
                                    <a class="blue" href="find.php">Find Nearest Pump</a>
                                </div>
          </li>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="logouth.php" name="logout"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
            </div>
          </li>
        </ul>
...
<!-- Price php -->
                ...
                <div class="row">
                    <div class="pricing-content">
                      ...
                      {
                        echo('<div class="col-md-3 col-sm-6 col-xs-">
                            <div class="pri_table_list">
                                ...
                                if($row['status'] == 2)
                                {
                                  echo'<span class="base">Premium</span>';
                                }
                                  echo(' <div class="rates">
                                        <span class="prices">'.$row['fuel'].'</span><span class="users"></span>
                                    </div>
                                    <span class="per-day">Per Litre</span>
                                </div>
                                <ol class="pricing-text">
                                    <li class="check">₹ '.$row['amt'].'</li>
                               
                                </ol>
                                <div class="price-btn blue">
                                    <a class="blue" href="order.php?pid='.$row['id'].'">Buy Now</a>
                                </div>
                            </div>
                        </div>');
                      }
