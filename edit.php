                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <?php
                            ...
                            if(isset($_POST['update'])) // when click on Update button
                            {
                              $idd=$_SESSION["idd"];
                                ...
                                $edit = mysqli_query($con,"update usign set password='$password', phone='$phone', email='$email' where id='$idd'");
                        ...
                        <form action="#" class="signin-form" method="POST">
                          <?php
                          include 'connect.php';
                           $result=mysqli_query($con,"SELECT * FROM `usign` WHERE uname='".$name."' ");
