                    ...
                    <div class="about-mission">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="mission-about">
                                ...
                                <div class="mission-text">
                                    <h4>Our Mission</h4>
                                    <p>To provide Roadside Fuel Assistance 24/7</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start column -->
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="mission-about">
                                ...
                                <div class="mission-text">
                                    <h4>Our Vision</h4>
                                    <p>To embrace smooth journey for our customers</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start column -->
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="mission-about">
                                ...
                                <div class="mission-text">
                                    ...
                                    <p>Specially trained professionals provides you homely experience</p>
                                </div>
                            </div>
                        </div>
                        <!-- End column -->
